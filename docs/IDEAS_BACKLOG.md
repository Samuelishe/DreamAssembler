...
- ослаблять remaining WPF-like / enterprise-clean controls: softer buttons, quieter dropdowns, flatter interaction, lower visual aggression;
...
- усиливать fullscreen reading mode как один из core experiences проекта;
- делать настройки похожими на atmospheric tuning, а не на giant settings matrix;
...
- начать curated exploration следующего atmospheric field вне текущего архива/транспорта, но без жанровых ярлыков;
