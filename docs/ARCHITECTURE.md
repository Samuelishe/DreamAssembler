...
- `TextGeneratorService` - главная точка генерации текста, учитывающая slot-требования, теги, анти-повторы, композиционные роли и базовый порядок narrative-фраз внутри `ShortText`.
