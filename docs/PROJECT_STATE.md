...
1. Дальше двигать UI в reader-first и phrase-first сторону, развивая новый fullscreen reading mode.
2. Усиливать atmospheric presentation без усложнения архитектуры, особенно вокруг selected-fragment spotlight в lexical modes.
3. Чистить и тематически уплотнять datasets раньше, чем наращивать новые режимы.
4. Развивать semantic coherence мягкими весами, тегами и curated-поднаборами, особенно для lexical modes.
5. Постепенно вводить atmospheric layers и atmosphere tags поверх текущей системы.
6. Дорабатывать narrative rhythm в `ShortText`.
