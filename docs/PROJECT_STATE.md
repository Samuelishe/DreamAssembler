...
1. При необходимости расширить тесты на новые правила генерации.
2. Продолжить наращивать наборы данных и шаблонов по жанрам и сценариям.
3. Расширить правила валидации и статистики по наборам данных.
4. Продолжить вводить более строгие slot-подкатегории там, где они реально улучшают качество.
5. Позже добавить редактор словарей и шаблонов.
