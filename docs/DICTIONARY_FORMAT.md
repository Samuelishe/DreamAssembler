...
## Отдельный формат словесных режимов

Режимы `Словосочетание` и `Несколько слов` не используют JSON-шаблоны и не зависят от `absurdity`.
...
- `Несколько слов`: прилагательное + существительное + глагол или прилагательное + прилагательное + существительное + глагол;
- род существительного определяет форму прилагательных и глагола прошедшего времени.
